...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-10 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Adicionar nova categoria no sistema</h4>
                ...
                @endif
                <form class="forms-sample" method="POST" action="{{ route('pages.categoryCreate') }}" enctype="multipart/form-data">
                  @csrf  
